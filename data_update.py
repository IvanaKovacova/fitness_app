...
# Import new data
df_new = pd.read_csv('data/data_new.csv', dtype='object', engine = 'python', usecols = [1,2,3,4,5,6,9])  
# df_new = pd.read_csv('data/data_new.csv', dtype='object', engine = 'python', sep=';', usecols = [1,2,3,4,5,6,9])  
...
df_new.loc[(df_new['Activity'] == 'unknown') & (df_new['Location'].str.contains('crosscountry ski', case = False)), 'Activity']  = 'Walk'
...
df_points.loc[(df_points['Milestone'] == False) & (df_points['Milestone'] == False) & (df_points['Bonus'].str.contains('2X')), 'Bonus'] = '2X'
df_points.loc[(df_points['Milestone'] == False) & (df_points['Comeback'] == False) & (df_points['Bonus'].str.contains('3X')), 'Bonus'] = '3X'
